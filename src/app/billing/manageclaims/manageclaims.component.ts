...
import { CreateNewClaimComponent } from './create-new-claim/create-new-claim.component';

@Component({
  selector: 'app-manageclaims',
  templateUrl: './manageclaims.component.html',
  styleUrls: ['./manageclaims.component.scss']
})
export class ManageclaimsComponent implements OnInit {
  ...
  public openClaimDialog(id) {
    let dialogRef = this.dialog.open(CreateNewClaimComponent, {
        data: id,
        height: 'auto',
        width: '750px'
    });
